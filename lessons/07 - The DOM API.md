...
2. **Explain the DOM hierarchy** in your own words using a "family tree" analogy (parents, children, and siblings).
3. Ask the AI to give you feedback on your explanation and suggest ways to make your understanding of "nodes" more precise.

Example Prompt:
> "I'm learning about the DOM. My understanding is that it's like a family tree where a `<div>` can be a parent and another element inside it is a child. Here is my full explanation: [your explanation]. What am I getting right, and what should I clarify about how nodes and elements relate to each other?"

# 7.2 Dev Tools

### Watch this video on how to use the developer tools in the browser: ###

[Using Developer Tools Video](https://www.youtube.com/watch?v=B_hUzbHeQOs)

### 🎉 Nice work on Lesson 7!
Next, complete the weekly assignment. Attend a mentor session if you have questions!
